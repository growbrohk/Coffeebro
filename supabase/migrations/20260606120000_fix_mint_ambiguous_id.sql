-- Fix: _mint_campaign_rewards_for_owner declares RETURNS TABLE (id, code), so PL/pgSQL
-- exposes output variables "id" and "code". Unqualified "where id = p_campaign_id" was
-- ambiguous with campaigns.id (42702). Affects free grab and free hunt claims equally.
