-- Allow primary org owners (no org_hosts row) and baristas to list campaign participants,
-- aligned with can_scan_vouchers_for_org (owner/host/manager/barista on org_hosts).
