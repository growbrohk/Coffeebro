...
export default function AdminOrgsPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    const row = {
      ...
      // Location-only fields nulled for online shops so discovery map + public profile
      // never pick up a stale storefront value.
              ...
              <div className="space-y-2">
                ...
                >
                  <label className="flex items-center gap-2 rounded-md border border-border px-3 py-2 text-sm">
                    <RadioGroupItem value="physical" id="admin-shop-type-physical" />
                    Physical shop
                  </label>
                  <label className="flex items-center gap-2 rounded-md border border-border px-3 py-2 text-sm">
                    <RadioGroupItem value="online" id="admin-shop-type-online" />
                    Online shop
                  </label>
                </RadioGroup>
                <p className="text-xs text-muted-foreground">
                  {draft.shop_type === 'online'
                    ? 'Online shops hide storefront fields. Manage pickup destinations under Claim spots below.'
